        ...
        <table id="all-authors" class="table table-bordered table-striped">
            <thead style="position: sticky; top: 0; background-color: white;">
                <tr class="bg-gray-100">
                    ...
                    <th class="py-2 border">Cellphone</th>
            ...
            <tbody>
                @foreach ($authors as $author)
                    <tr>
                        <td class="py-2 border">{{ $author['firstname'] }}</td>
                        <td class="py-2 border">{{ $author['lastname'] }}</td>
                        <td class="py-2 border">{{ $author['email'] }}</td>
                        <td class="py-2 border">{{ $author['cellphone'] }}</td>
                        <td class="py-2 border">{{ $author['message'] }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
